...
const MessageDetail = () => {
 ...
 useEffect(()=>{
  ...
  const handleNavigation = (bolno, data, statuscode) => {
    navigate("/modify", {
      state: { id: data, bolno: bolno, statuscode: statuscode },
    });
  };
              ...
              <div className="col-sm-12">
                ...
                <ol className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">
                    {" "}
                    {status_code === 1 && "Raw Data Received"}
                    {status_code === 2 && "Validation Failed"}
                    {status_code === 3 && "Validation Successful"}
                    {status_code === 4 && "Details Inserted"}
                    {status_code === 5 && "Details Insertion Failed"}
                    {status_code === 6 && "Transfer Successful"}
                    {status_code === 7 && "Transfer Failed"}
                  </li>
                </ol>
              </div>
            </div>
